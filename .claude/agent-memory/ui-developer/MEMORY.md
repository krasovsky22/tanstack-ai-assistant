# UI Developer Agent Memory

## Project Patterns

- [Layout: 3-column app shell](project_layout.md) — Icon rail + chat sidebar + main content area
- [Chakra UI conventions](chakra_conventions.md) — Component patterns, theme setup, known gotchas

export { BedrockTextAdapter, type BedrockTextConfig, type BedrockInputModalities } from './adapters/text'
export { createBedrockChat, bedrockText } from './bedrock-chat'
export {
...
export type { BedrockTextProviderOptions, BedrockThinkingOptions, BedrockInferenceConfig } from './text-provider-options'
